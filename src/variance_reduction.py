...
if __name__ == "__main__":
    ...
    print("=" * 65)
    print(f"{'METHOD':<25} {'PRICE':>10} {'STD ERR':>10} {'VAR RED':>10}")
    print("=" * 65)
    print(f"{'Black-Scholes':<25} {bs:>10.6f} {'':>10} {'':>10}")
    print(f"{'Naive MC':<25} {mc['price']:>10.6f} {mc['stderr']:>10.6f} {'--':>10}")
    print(f"{'Antithetic MC':<25} {av['price']:>10.6f} {av['stderr']:>10.6f} {(1 - (av['stderr']/mc['stderr'])**2)*100:>9.1f}%")
    print(f"{'Control Variate MC':<25} {cv['price']:>10.6f} {cv['stderr']:>10.6f} {(1 - (cv['stderr']/mc['stderr'])**2)*100:>9.1f}%")
    print("=" * 65)
    print(f"\nBS within Naive MC CI:      {mc['ci95'][0] <= bs <= mc['ci95'][1]}")
    print(f"BS within Antithetic CI:    {av['ci95'][0] <= bs <= av['ci95'][1]}")
    print(f"BS within Control Var CI:   {cv['ci95'][0] <= bs <= cv['ci95'][1]}")